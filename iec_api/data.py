...
from iec_api.models.remote_reading import ReadingResolution, RemoteReadingRequest, RemoteReadingResponse, SmartMeter
...
async def get_remote_reading(
    ...
    token: JWT,
    contract_id: str,
    smart_meters_list: list[SmartMeter],
    ...
    req = RemoteReadingRequest(
        ...
        smart_meters_list=smart_meters_list,
