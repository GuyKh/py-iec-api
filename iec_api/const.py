...
GET_DEVICE_IN_URL = IEC_API_BASE_URL + "DeviceIn/{bp_number}"
GET_INVOICE_PDF_URL = IEC_API_BASE_URL + "BillingCollection/pdf"
GET_KWH_TARIFF_URL = IEC_API_BASE_URL + "content/he-IL/content/tariffs/tariffslobby/electricitytariffs"
