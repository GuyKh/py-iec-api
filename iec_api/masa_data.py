...
from iec_api.masa_api_models.user_profile import UserProfile
...
async def get_masa_user_profile(session: ClientSession, token: JWT, account_id: str) -> UserProfile:
...
async def get_masa_equipments(session: ClientSession, token: JWT, account_id: str) -> UserProfile:
